...
import readme from 'stories/docs/finalForm/SignatureCanvas/readme.md'
import canvasContainerPropsMd from 'stories/docs/finalForm/SignatureCanvas/canvasContainerProps.md'
import canvasPropsMd from 'stories/docs/finalForm/SignatureCanvas/canvasProps.md'
import classNamesMd from 'stories/docs/finalForm/SignatureCanvas/classNames.md'
import clearBtnPropsMd from 'stories/docs/finalForm/SignatureCanvas/clearBtnProps.md'
import clearSignatureMd from 'stories/docs/finalForm/SignatureCanvas/clearSignature.md'
import hideClearMd from 'stories/docs/finalForm/SignatureCanvas/hideClear.md'
import onDrawEndMd from 'stories/docs/finalForm/SignatureCanvas/onDrawEnd.md'
import penColorMd from 'stories/docs/finalForm/SignatureCanvas/penColor.md'
import signatureRefMd from 'stories/docs/finalForm/SignatureCanvas/signatureRef.md'
import signatureCaptionMd from 'stories/docs/finalForm/SignatureCanvas/signatureCaption.md'
import signatureLabelMd from 'stories/docs/finalForm/SignatureCanvas/signatureLabel.md'
import xPropsMd from 'stories/docs/finalForm/SignatureCanvas/xProps.md'
