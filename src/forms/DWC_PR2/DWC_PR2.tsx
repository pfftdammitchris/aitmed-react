...
import { ICD10 } from '../../modules/finalForm'
        ...
        render={({ handleSubmit, submitting, ...rest }: any) => (
          <form onSubmit={handleSubmit} className={classes.root}>
            ...
            <Typography variant="body2">
              Check the box(es) which indicate why you are submitting a report
              at this time. If the patient is “Permanent and Stationary” (i.e.,
              has reached maximum medical improvement), do not use this form.
              You may use DWC Form PR-3 or IMC Form 81556.
            </Typography>
            ...
            <Typography gutterBottom paragraph italic>
              The information below must be provided. You may use this form or
              you may substitute or append a narrative report.
            </Typography>
            ...
            <Label>
              ...
              <Typography variant="caption">
                (Include significant physical examination, laboratory, imaging,
            ...
            <Typography variant="body1" gutterBottom paragraph>
              ...
              <strong>
                Identify each physician and non-physician provider
              </strong>
              . Specify type, frequency and duration of physical medicine
              services (e.g., physical therapy, manipulation, acupuncture). Use
              of CPT codes is encouraged. Have there been any{' '}
              <strong>changes</strong> in treatment plan? If so, why?
            </Typography>
            <Field
              name="treatmentPlan"
              component={OutlinedTextField}
            ...
            <Flex xsBlock spaceBetween>
              ...
              <Field
                ...
                fullWidth
              >
                {['Select Specialty', ...specialties].map(
                  (specialty: string) => (
