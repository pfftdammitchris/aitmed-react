import React, { Children, isValidElement, cloneElement, useState, useCallback, useEffect } from 'react';
...
var elementAcceptingRef = chainPropTypes(propTypes_1, acceptingRef);
elementAcceptingRef.isRequired = chainPropTypes(propTypes_1.isRequired, acceptingRef);
...
function ThemeProvider(props) {
  ...
  process.env.NODE_ENV !== "production" ? warning_1(outerTheme !== null || typeof localTheme !== 'function', ['Material-UI: you are providing a theme function prop to the ThemeProvider component:', '<ThemeProvider theme={outerTheme => outerTheme} />', '', 'However, no outer theme is present.', 'Make sure a theme is already injected higher in the React tree ' + 'or provide a theme object.'].join('\n')) : void 0;
...
function createPalette(palette) {
  ...
  var paletteOutput = cjs$1(_extends({
...
var MaterialUIButton = withStyles$1(styles$2, {
  name: 'MuiButton'
})(Button);
...
var Button$1 = function Button(_ref) {
  ...
  var className = _ref.className,
      ...
      others = _objectWithoutProperties$1(_ref, ["className", "children", "primary", "secondary", "thirdary", "neutral", "error", "red", "danger", "hover", "small", "medium", "large", "xlarge", "size", "disabled", "outlined", "to", "textColor", "background", "overwriteClassName", "overWrittenClassNames", "centerOnSmall"]);
...
var Paper$1 = withStyles$1(styles$3, {
  name: 'MuiPaper'
})(Paper);
...
var Card$1 = withStyles$1(styles$4, {
  name: 'MuiCard'
})(Card);
...
var MuiDivider = withStyles$1(styles$5, {
  name: 'MuiDivider'
})(Divider);
...
var CardContent$1 = withStyles$1(styles$6, {
  name: 'MuiCardContent'
})(CardContent);
...
var MUITypography = withStyles$1(styles$8, {
  name: 'MuiTypography',
  withTheme: true
})(Typography);
...
var SvgIcon$1 = withStyles$1(styles$9, {
  name: 'MuiSvgIcon'
})(SvgIcon);
...
var IconButton$1 = withStyles$1(styles$a, {
  name: 'MuiIconButton'
})(IconButton);
...
var SwitchBase$1 = withStyles$1(styles$b, {
...
var MuiCheckbox = withStyles$1(styles$c, {
  name: 'MuiCheckbox'
})(Checkbox);
...
var CircularProgress$1 = withStyles$1(styles$d, {
...
var FormControlLabel = React.forwardRef(function FormControlLabel(props, ref) {
  ...
  return React.createElement("label", _extends({
    ...
    ref: ref
  }, other), React.cloneElement(control, controlProps), React.createElement(MUITypography, {
    component: "span",
...
var FormControlLabel$1 = withStyles$1(styles$k, {
...
var FormHelperText$1 = withStyles$1(styles$l, {
...
function useMediaQuery(queryInput) {
  ...
  process.env.NODE_ENV !== "production" ? warning_1(typeof queryInput !== 'function' || theme !== null, ['Material-UI: the `query` argument provided is invalid.', 'You are providing a function without a theme in the context.', 'One of the parent elements needs to use a ThemeProvider.'].join('\n')) : void 0;
...
Input.muiName = 'Input';
var Input$1 = withStyles$1(styles$o, {
  name: 'MuiInput'
})(Input);
...
var Popover$1 = withStyles$1(styles$r, {
  name: 'MuiPopover'
})(Popover);
...
var Menu = React.forwardRef(function Menu(props, ref) {
  ...
  var items = React.Children.map(children, function (child, index) {
    ...
    process.env.NODE_ENV !== "production" ? warning_1(child.type !== React.Fragment, ["Material-UI: the Menu component doesn't accept a Fragment as a child.", 'Consider providing an array instead.'].join('\n')) : void 0;
...
var Menu$1 = withStyles$1(styles$s, {
  name: 'MuiMenu',
  withTheme: true
})(Menu);
...
var NotchedOutline$1 = withStyles$1(styles$u, {
...
var OutlinedInput$1 = withStyles$1(styles$v, {
...
var SelectInput = React.forwardRef(function SelectInput(props, ref) {
  ...
  var items = React.Children.map(children, function (child) {
    ...
    process.env.NODE_ENV !== "production" ? warning_1(child.type !== React.Fragment, ["Material-UI: the Select component doesn't accept a Fragment as a child.", 'Consider providing an array instead.'].join('\n')) : void 0;
    var selected;
...
var Select$1 = withStyles$1(styles$w, {
  name: 'MuiSelect'
})(Select);
...
var TextField$1 = withStyles$1(styles$x, {
  name: 'MuiTextField'
})(TextField);
...
var Typography$1 = function Typography(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(MUITypography, _extends$1({
...
var Cardv2 = function Cardv2(_ref) {
  ...
  var CardDivider = function CardDivider(_ref2) {
    ...
    return React.createElement(MuiDivider, _extends$1({
  ...
  var CardHeader = function CardHeader(_ref3) {
    ...
    return React.createElement(Typography$1, _extends$1({
...
var Checkbox$1 = function Checkbox(_ref) {
  ...
  }, wrapperRootProps), React.createElement(FormControlLabel$1, _extends$1({
    control: React.createElement(MuiCheckbox, _extends$1({
      classes: classNames
    }, checkboxProps)),
    label: label
  }, rest)), !textField && withTextField && React.createElement(TextField$1, withTextField), textField);
};
...
var SpinnerWithWidth = function SpinnerWithWidth(_ref) {
  ...
  return React.createElement(CircularProgress$1, _extends$1({
...
var LoadingSpinner = function LoadingSpinner(_ref3) {
  ...
  }, React.createElement(EnhancedSpinnerWithWidth, _extends$1({
...
export { Button$1 as Button, Cardv2 as Card, Checkbox$1 as Checkbox, Divider$1 as Divider, Flex, LoadingSpinner, AiTmedThemeProvider as ThemeProvider, Typography$1 as Typography };
