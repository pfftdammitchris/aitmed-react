...
var Signature = _interopDefault(require('react-signature-canvas'));
...
var createDecorator = _interopDefault(require('final-form-focus'));
...
var DWC_1_Employee = function DWC_1_Employee(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Typography, {
    variant: "h6",
    gutterBottom: true
  }, "Employee"), React.createElement(Flex, null, React.createElement(reactFinalForm.Field, {
    label: "Name",
    ...
    fullWidth: true
  }), React.createElement(reactFinalForm.Field, {
    type: "date",
    label: "Today's Date",
    ...
    component: FinalFormOutlinedTextField,
    fullWidth: true
  }), React.createElement(Flex, null, React.createElement(reactFinalForm.Field, {
    label: "City",
  ...
  })), React.createElement(reactFinalForm.Field // @ts-ignore
  , {
...
var DWC_1_Employee$1 = function DWC_1_Employee(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Typography, {
    variant: "h6",
    gutterBottom: true
  }, "Employer"), React.createElement(reactFinalForm.Field, {
    label: "Name",
    name: "".concat(name, ".name"),
    component: FinalFormOutlinedTextField,
    fullWidth: true
...
var DWC_PR1 = function DWC_PR1(_ref) {
  ...
  return React.createElement(reactFinalForm.Form, _extends({
...
var ICD10SearchInput = function ICD10SearchInput(_ref2) {
  ...
  var SearchInput = function SearchInput(_ref3) {
    ...
    return React.createElement(Input, getInputProps(_objectSpread2({
      startAdornment: React.createElement(io.IoIosSearch, {
...
var useStyles$c = styles.makeStyles({
  root: {
    marginBottom: 6
  },
  statusCaption: {
...
var ICD10RowRenderer = function ICD10RowRenderer(_ref) {
  ...
  }), React.createElement(TableCell, null, React.createElement(io.IoIosCloseCircle, {
    onClick: onDelete,
...
var PatientInfo = function PatientInfo(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Flex, null, React.createElement(reactFinalForm.Field, {
...
var PR2 = function PR2(_ref2) {
  ...
  var signatureCanvas = React.createElement(reactFinalForm.Field, {
    component: FinalFormSignatureCanvas,
    name: "signature",
    signatureRef: signatureRef
  });
  return React.createElement(reactFinalForm.Form, _extends({
    ...
    render: function render(_ref3) {
      ...
      return React.createElement("form", {
        ...
        paragraph: true,
        italic: true
      }, "The information below must be provided. You may use this form or you may substitute or append a narrative report."), React.createElement(Label, null, "Subjective Complaints:"), React.createElement(reactFinalForm.Field, {
        ...
        variant: "caption"
      }, "(Include significant physical examination, laboratory, imaging, or other diagnostic findings.)")), React.createElement(reactFinalForm.Field, {
        ...
        multiline: true,
        fullWidth: true
      }), React.createElement("br", null), React.createElement("br", null), React.createElement(Label, null, "Diagnoses:"), React.createElement(reactFinalFormArrays.FieldArray, {
        component: ICD10,
        name: "diagnoses"
        ...
        variant: "caption"
      }, "Primary Treating Physician: (Original signature, do not stamp)"), React.createElement(reactFinalForm.Field, {
        name: "dateOfExam",
        type: "date",
        ...
        variant: "body2"
      }, "Next report due no later than: \xA0\xA0"), React.createElement(reactFinalForm.Field, {
...
var RFA_UROResponse = function RFA_UROResponse(_ref) {
  var name = _ref.name,
      ...
      signatureRef = _ref.signatureRef;
  return React.createElement(React.Fragment, null, React.createElement(reactFinalForm.Field, {
  ...
  , {
    ...
    signatureRef: signatureRef
  }), React.createElement("br", null), React.createElement(reactFinalForm.Field, {
    label: "Comments",
...
var DWC_RFA = function DWC_RFA(_ref) {
  ...
  return React.createElement(reactFinalForm.Form, {
    keepDirtyOnReinitialize: true,
    onSubmit: onSubmit,
    subscription: {
      submitting: true
    ...
    render: function render(_ref3) {
      ...
      return React.createElement("form", {
        onSubmit: handleSubmit,
        className: classes.root
      }, React.createElement(RFA_Header, null), React.createElement(RFA_Subheader, null), React.createElement(Divider, null), React.createElement(reactFinalForm.Field, {
        component: WrappedCheckbox,
        type: "checkbox",
        label: "New Request",
        name: "newRequest"
        ...
        gutterBottom: true,
        paragraph: true
      }, "List each specific requested medical services, goods, or items in the below space or indicate the specific page number(s) of the attached medical report on which the requested treatment can be found. Up to five (5) procedures may be entered."), React.createElement(reactFinalForm.Field // @ts-ignore
      , {
        component: FinalFormSignatureCanvas,
...
exports.DWC_PR1 = DWC_PR1;
exports.DWC_PR2 = PR2;
exports.DWC_RFA = DWC_RFA;
