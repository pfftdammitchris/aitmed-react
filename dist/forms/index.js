...
var dist = require('react-final-form/dist');
var arrayMutators = _interopDefault(require('final-form-arrays/dist'));
var formatString = _interopDefault(require('format-string-by-pattern/dist'));
var dist$1 = require('react-final-form-arrays/dist');
var Downshift = _interopDefault(require('downshift/dist'));
...
var DWC_1_Employee = function DWC_1_Employee(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Typography$2, {
    variant: "h6",
    gutterBottom: true
  }, "Employee"), React.createElement(Flex, null, React.createElement(dist.Field, {
    label: "Name",
    ...
    fullWidth: true
  }), React.createElement(dist.Field, {
    type: "date",
    label: "Today's Date",
    ...
    component: FinalFormOutlinedTextField,
    fullWidth: true
  }), React.createElement(Flex, null, React.createElement(dist.Field, {
    label: "City",
  ...
  })), React.createElement(dist.Field // @ts-ignore
  , {
...
var DWC_1_Employee$1 = function DWC_1_Employee(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Typography$2, {
    variant: "h6",
    gutterBottom: true
  }, "Employer"), React.createElement(dist.Field, {
    label: "Name",
    name: "".concat(name, ".name"),
    component: FinalFormOutlinedTextField,
    fullWidth: true
...
var DWC_PR1 = function DWC_PR1(_ref) {
  ...
  return React.createElement(dist.Form, _extends({
...
var PatientInfo = function PatientInfo(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Flex, null, React.createElement(dist.Field, {
...
var PR2 = function PR2(_ref2) {
  ...
  var signatureCanvas = React.createElement(dist.Field, {
    component: FinalFormSignatureCanvas,
    name: "signature",
    signatureRef: signatureRef
  });
  return React.createElement(dist.Form, _extends({
    ...
    render: function render(_ref3) {
      ...
      return React.createElement("form", {
        ...
        paragraph: true,
        italic: true
      }, "The information below must be provided. You may use this form or you may substitute or append a narrative report."), React.createElement(Label, null, "Subjective Complaints:"), React.createElement(dist.Field, {
        ...
        variant: "caption"
      }, "(Include significant physical examination, laboratory, imaging, or other diagnostic findings.)")), React.createElement(dist.Field, {
        ...
        multiline: true,
        fullWidth: true
      }), React.createElement("br", null), React.createElement("br", null), React.createElement(Label, null, "Diagnoses:"), React.createElement(dist$1.FieldArray, {
        component: ICD10,
        name: "diagnoses"
        ...
        variant: "caption"
      }, "Primary Treating Physician: (Original signature, do not stamp)"), React.createElement(dist.Field, {
        name: "dateOfExam",
        type: "date",
        ...
        variant: "body2"
      }, "Next report due no later than: \xA0\xA0"), React.createElement(dist.Field, {
...
var _extends$1 = _interopDefault$1(require('@babel/runtime/helpers/extends'));
var _objectWithoutPropertiesLoose$1 = _interopDefault$1(require('@babel/runtime/helpers/objectWithoutPropertiesLoose'));
...
var RFA_UROResponse = function RFA_UROResponse(_ref) {
  var name = _ref.name,
      ...
      signatureRef = _ref.signatureRef;
  return React.createElement(React.Fragment, null, React.createElement(dist.Field, {
  ...
  , {
    ...
    signatureRef: signatureRef
  }), React.createElement("br", null), React.createElement(dist.Field, {
    label: "Comments",
...
var DWC_RFA = function DWC_RFA(_ref) {
  ...
  return React.createElement(dist.Form, {
    keepDirtyOnReinitialize: true,
    onSubmit: onSubmit,
    subscription: {
      submitting: true
    ...
    render: function render(_ref3) {
      ...
      return React.createElement("form", {
        onSubmit: handleSubmit,
        className: classes.root
      }, React.createElement(RFA_Header, null), React.createElement(RFA_Subheader, null), React.createElement(Divider$3, null), React.createElement(dist.Field, {
        component: WrappedCheckbox,
        type: "checkbox",
        label: "New Request",
        name: "newRequest"
        ...
        gutterBottom: true,
        paragraph: true
      }, "List each specific requested medical services, goods, or items in the below space or indicate the specific page number(s) of the attached medical report on which the requested treatment can be found. Up to five (5) procedures may be entered."), React.createElement(dist.Field // @ts-ignore
      , {
        component: FinalFormSignatureCanvas,
