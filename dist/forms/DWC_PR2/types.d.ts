declare type FormReasonValue = 'periodicReport' | 'changeInTreatmentPlan' | 'discharged' | 'changeInWorkStatus' | 'referralOrConsultation' | 'infoRequestedBy' | 'changeInPatientsCondition' | 'surgeryOrHospitalization' | 'other' | string;
