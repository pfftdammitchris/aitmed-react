...
var createMuiTheme = /*#__PURE__*/Object.freeze({
...
var _createMuiTheme = _interopRequireDefault$1(createMuiTheme);
...
var require$$0 = getCjsExportFromNamespace(_extends$1);
...
var _extends2 = _interopRequireDefault$1(require$$0);



var _defaultTheme = _interopRequireDefault$1(defaultTheme_1);
...
var require$$0$1 = getCjsExportFromNamespace(defineProperty);
...
var _defineProperty2 = _interopRequireDefault$1(require$$0$1);
...
var require$$1 = getCjsExportFromNamespace(dist);
...
var _convertCssLength = _interopRequireDefault$1(require$$1);
...
var _createStyles = _interopRequireDefault$1(createStyles_1);

var _makeStyles = _interopRequireDefault$1(makeStyles_1);

var _MuiThemeProvider = _interopRequireDefault$1(MuiThemeProvider);

var _responsiveFontSizes = _interopRequireDefault$1(responsiveFontSizes_1);

var _styled = _interopRequireDefault$1(styled_1);
...
var _withStyles = _interopRequireDefault$1(withStyles_1);

var _withTheme = _interopRequireDefault$1(withTheme_1);
});

unwrapExports(styles$1);
var styles_1 = styles$1.createMuiTheme;



var ThemeProvider = /*#__PURE__*/Object.freeze({

});

var ThemeProvider$1 = createCommonjsModule(function (module, exports) {
...
var _ThemeProvider = _interopRequireDefault$1(ThemeProvider);
});

var ThemeProvider$2 = unwrapExports(ThemeProvider$1);
...
var AiTmedThemeProvider = function AiTmedThemeProvider(_ref) {
  ...
  var theme$1 = styles_1(themeProp || theme);
  return React__default.createElement(ThemeProvider$2, {
    theme: styles_1(theme$1)
  }, children);
};
...
var Button$2 = function Button(_ref) {
  ...
  return React__default.createElement(MaterialUIButton, _extends$2({
    style: {
      background: background
    },
...
var _Card = _interopRequireDefault$1(Card);
});
...
var MuiDivider = unwrapExports(Divider$1);



var CardContent = /*#__PURE__*/Object.freeze({
...
var _CardContent = _interopRequireDefault$1(CardContent);
});
...
var _react = _interopRequireDefault$1(React__default);
...
var _useTheme = _interopRequireDefault$1(useTheme_1$1);
});
...
var Typography$2 = function Typography(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(MUITypography, _extends$2({
...
var Cardv2 = function Cardv2(_ref) {
  ...
  var CardDivider = function CardDivider(_ref2) {
    ...
    return React__default.createElement(MuiDivider, _extends$2({
  ...
  var CardHeader = function CardHeader(_ref3) {
    ...
    return React__default.createElement(Typography$2, _extends$2({
  ...
  return React__default.createElement(Card$2, _extends$2({
    className: classnames(classes.root, className, classNames.card, _defineProperty$1({}, classes.square, !!square))
  }, rest), React__default.createElement(CardContent$2, _extends$2({
    classes: {
...
var Checkbox$2 = function Checkbox(_ref) {
  ...
  }, wrapperRootProps), React__default.createElement(FormControlLabel$2, _extends$2({
    control: React__default.createElement(MuiCheckbox, _extends$2({
      classes: classNames
    }, checkboxProps)),
    label: label
  }, rest)), !textField && withTextField && React__default.createElement(TextField$2, withTextField), textField);
};
...
var Divider$2 = function Divider(_ref3) {
...
var SpinnerWithWidth = function SpinnerWithWidth(_ref) {
  ...
  return React__default.createElement(CircularProgress$2, _extends$2({
...
var LoadingSpinner = function LoadingSpinner(_ref3) {
  ...
  return React__default.createElement("div", {
  ...
  }, React__default.createElement(EnhancedSpinnerWithWidth, _extends$2({
    ...
    title: "AiTmed"
  }))), React__default.createElement(Fade$2, {
    timeout: 2000,
    "in": true
  }, isFunction_1(renderContent) ? // @ts-ignore
  renderContent() : React__default.createElement(Typography$2, {
