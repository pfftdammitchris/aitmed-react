...
var useStyles = styles.makeStyles(function(theme) {
  ...
  return {
    ...
    subtitle1:
      ((_subtitle = {}),
      _defineProperty(_subtitle, theme.breakpoints.down('sm'), {
        fontSize: '0.9em',
      }),
    ...
    subtitle2:
      ((_subtitle2 = {}),
      _defineProperty(_subtitle2, theme.breakpoints.down('sm'), {
        fontSize: '0.8em',
      }),
    ...
    body2:
      ((_body2 = {}),
      _defineProperty(_body2, theme.breakpoints.down('sm'), {
        fontSize: '0.73em',
      }),
    ...
    caption:
      ((_caption = {}),
      _defineProperty(_caption, theme.breakpoints.down('sm'), {
        fontSize: '0.7em',
      }),
      ...
      _extends(
        {
          ...
          className: cx.apply(
            ...
            [className].concat(classNames, [
              ((_ref2 = {}),
              _defineProperty(_ref2, classes.primary, !!primaryProp),
              _defineProperty(_ref2, classes.secondary, !!secondaryProp),
              _defineProperty(_ref2, classes.thirdary, !!thirdaryProp),
              _defineProperty(_ref2, classes.darkBlue, !!darkBlue),
              _defineProperty(_ref2, classes.link, !!link),
              _defineProperty(_ref2, classes.italic, !!italic),
              _defineProperty(_ref2, classes.unselected, !!unselected),
              _ref2),
            ]),
          ), // @ts-ignore
...
function random(lower, upper, floating) {
  if (
    ...
    _isIterateeCall(lower, upper, floating)
  ) {
...
var useLoadingSpinner = function useLoadingSpinner() {
  ...
  var getRandomColor = React.useCallback(
    function() {
      var colors = [
        primary.lightest,
        primary.lighter,
  ...
  return React__default.createElement(
    'div',
    {
      ...
      className: cx(
        ...
        wrapperClassName,
        ((_cx = {}),
        _defineProperty(_cx, classes.fullscreen, !!fullscreen),
        _defineProperty(_cx, classes.dim, !!dim),
        _cx),
      ),
    },
    React__default.createElement(
          ...
          : React__default.createElement(
              Typography,
              {
                className: cx(
                  ...
                  childrenClassName,
                  ((_cx2 = {}),
                  _defineProperty(_cx2, classes.xxs, !!rest.xxs),
                  _defineProperty(_cx2, classes.xs, !!rest.xs),
                  _defineProperty(_cx2, classes.sm, !!rest.sm),
                  _defineProperty(_cx2, classes.md, !!rest.md),
                  _defineProperty(_cx2, classes.lg, !!rest.lg),
                  _defineProperty(_cx2, classes.xl, !!rest.xl),
                  _cx2),
                ),
                style: _objectSpread2(
                  {
...
var statesArrayObjectsMapper = statesArrayObjects.reduce(function(
  acc,
  stateObj,
) {
...
{})
var statesArrayObjectsMapperv2 = statesArrayObjects.reduce(function(
  acc,
  stateObj,
) {
...
var getCardProps = function getCardProps() {
  ...
  var _values$card_number = values.card_number,
    ...
    billing_first_name =
      _values$billing_first === void 0 ? '' : _values$billing_first,
    _values$billing_last_ = values.billing_last_name,
    billing_last_name =
      _values$billing_last_ === void 0 ? '' : _values$billing_last_,
...
var useCreditCard = function useCreditCard() {
    ...
    var newValue =
      issuer === 'amex'
        ? ''
            ...
            .concat(value.slice(4, 10), ' ')
            .concat(value.slice(10, 15))
        : issuer === 'dinersclub'
        ? ''
            .concat(value.slice(0, 4), ' ')
            .concat(value.slice(4, 10), ' ')
            .concat(value.slice(10, 14))
        : ''
            .concat(value.slice(0, 4), ' ')
            .concat(value.slice(4, 8), ' ')
            .concat(value.slice(8, 12), ' ')
            .concat(value.slice(12, 19))
  ...
  var parse = function parse(value, name) {
    ...
    return !clearValue
      ...
      : name === 'cvv_code'
      ? ''.concat(clearValue.slice(0, issuer === 'amex' ? 4 : 3)).trim()
      : name === 'billing_zip_code'
      ? ''.concat(clearValue.slice(0, 5)).trim()
      : value
  }
...
var CreditCardForm = function CreditCardForm(_ref) {
  ...
  var defaultRenderer = function defaultRenderer(formApi) {
    ...
    return React__default.createElement(
      ...
      !!midLabel &&
        React__default.createElement(CreditCardFormMidLabel, null, midLabel),
      isSubmitting &&
        React__default.createElement(
          LoadingSpinner,
          {
