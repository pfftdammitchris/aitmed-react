...
var dist$1 = require('react-final-form/dist');
...
var CreditCardForm = function CreditCardForm(_ref) {
  ...
  var renderTextField = function renderTextField(_ref2) {
    ...
    return React__default.createElement(TextField$1, _extends({
      InputLabelProps: {
        classes: {
  ...
  var defaultRenderer = function defaultRenderer(formApi) {
    ...
    return React__default.createElement("form", {
    ...
    }, submittingText || 'Submitting...'), React__default.createElement(dist$1.Field, {
      label: "Card Number",
      name: "card_number",
      parse: parse,
      render: finalRenderTextField
    }), React__default.createElement(dist$1.Field, {
      label: "Month",
      name: "month",
      items: months,
      render: finalRenderSelectField
      ...
      variant: "h5",
      secondary: true
    }, "Billing Information"), React__default.createElement(dist$1.Field, {
      name: "billing_first_name",
      label: "First Name",
      render: finalRenderTextField
    }), React__default.createElement(dist$1.Field, {
      ...
      parse: parse,
      render: finalRenderTextField
    }), isFunction_1(renderSubmit) ? renderSubmit && renderSubmit(formApi) : React__default.createElement(Grid$1, {
  ...
  return React__default.createElement(dist$1.Form, _extends({
