...
var Typography$2 = function Typography(_ref) {
  ...
  }, props)), divider && React__default.createElement(Divider$2, null));
};
...
var SpinnerWithWidth = function SpinnerWithWidth(_ref) {
  ...
  return React__default.createElement(CircularProgress$2, _extends({
...
var CreditCardForm = function CreditCardForm(_ref) {
  ...
  var renderTextField = function renderTextField(_ref2) {
    ...
    return React__default.createElement(TextField$2, _extends({
      InputLabelProps: {
        classes: {
  ...
  var renderSelectField = function renderSelectField(_ref3) {
    ...
    return React__default.createElement(TextField$2, _extends({
      ...
      return React__default.createElement(MenuItem$2, {
  ...
  var defaultRenderer = function defaultRenderer(formApi) {
    ...
    return React__default.createElement("form", {
    ...
    }, submittingText || 'Submitting...'), React__default.createElement(dist.Field, {
      label: "Card Number",
      name: "card_number",
      parse: parse,
      render: finalRenderTextField
    }), React__default.createElement(dist.Field, {
      label: "Month",
      name: "month",
      items: months,
      render: finalRenderSelectField
      ...
      variant: "h5",
      secondary: true
    }, "Billing Information"), React__default.createElement(dist.Field, {
      name: "billing_first_name",
      label: "First Name",
      render: finalRenderTextField
    }), React__default.createElement(dist.Field, {
      ...
      parse: parse,
      render: finalRenderTextField
    }), isFunction_1(renderSubmit) ? renderSubmit && renderSubmit(formApi) : React__default.createElement(Grid$2, {
      className: classes.buttonContainer,
      direction: "column",
      alignItems: "center",
      justify: "center",
      container: true
    }, React__default.createElement(Grid$2, {
      xs: 12,
      item: true
  ...
  return React__default.createElement(dist.Form, _extends({
