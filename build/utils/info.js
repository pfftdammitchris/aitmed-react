...
export var statesArrayObjectsMapper = statesArrayObjects.reduce(function (acc, stateObj) {
    if (acc[stateObj.name] === undefined) {
        acc[stateObj.name] = stateObj;
    }
    return acc;
}, {});
export var statesArrayObjectsMapperv2 = statesArrayObjects.reduce(function (acc, stateObj) {
...
export var languagesList = languages.map(function (_a) {
    var code = _a.code;
    return code;
});
export var languagesMapper = languages.reduce(function (acc, lang) {
    if (!acc[lang.code]) {
        acc[lang.code] = lang;
    }
    return acc;
